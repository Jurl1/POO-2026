/****************************************************************************
** Meta object code from reading C++ file 'LoginYFormulario.h'
**
...
#error "The header file 'LoginYFormulario.h' doesn't include <QObject>."
...
namespace {
struct qt_meta_tag_ZN10FormularioE_t {};
} // unnamed namespace

template <> constexpr inline auto Formulario::qt_create_metaobjectdata<qt_meta_tag_ZN10FormularioE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Formulario, qt_meta_tag_ZN10FormularioE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Formulario::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10FormularioE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10FormularioE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10FormularioE_t>.metaTypes,
    nullptr
} };
...
void *Formulario::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10FormularioE_t>.strings))
...
void Login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->validarCredenciales(); break;
        default: ;
        }
    }
    (void)_a;
